...
public class Static
{
    ...
    public static Genome xorGenome()
    {
        ...
        ConnectionGene[] connectionGenes = new ConnectionGene[]
        {
            ...
            new ConnectionGene(0, 3, 4, true, 2),
            new ConnectionGene(1, 3, 4, true, 3),
            new ConnectionGene(2, 3, -6, true, 4),
            new ConnectionGene(2, 4, -2, true, 6),
            new ConnectionGene(3, 4, -6, true, 5)
        };
        ArrayList<ConnectionGene> connectionGenesList = new ArrayList<>();
        for (ConnectionGene g : connectionGenes)
        {
